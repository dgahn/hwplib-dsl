...
한컴 문서를 만들기 위한 DSL입니다. [hwplib](https://github.com/neolord0/hwplib) 를 좀 더 편리하게 사용하기 위한 목적으로 만들게 되었습니다.
...
- [Kotlin html](https://github.com/Kotlin/kotlinx.html) 을 참고해서 만들었습니다.